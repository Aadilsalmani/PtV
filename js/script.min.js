...
// ✨ Toast for update notification
function showUpdateToast() {
  const toast = document.createElement("div");
  toast.id = "update-toast";
  toast.innerHTML = "✨ PtV updated! Tap to refresh";
