...
const DATA_URL = "https://raw.githubusercontent.com/Aadilsalmani/PtV/main/data/tourist_data.json";
...
fetch(DATA_URL)
  ...
  .catch(err => {
    console.error("⚠️ Data load error:", err);
    locateUser(); // still load map even if data fails
  });
  .then(res => res.json())
  .then(data => {
