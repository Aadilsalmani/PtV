  ...
  if (userLat && userLon) {
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      err => {
        ...
        console.warn("Locate button error:", err.message);
      }
    );
  } else {
