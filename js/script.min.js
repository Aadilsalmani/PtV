...
window.addEventListener("DOMContentLoaded", () => {
  ...
  // 🗺️ Load data
  const API_URL = "https://script.google.com/macros/s/AKfycbzsO2xFDpRNJbsHwnvEI6u1MHqKGHqNIEo3gNsoTNqso6W9xKu7DvFPlEcoX3iGmYY4/exec";
  const API_KEY = ["AADIL", "87", "161"].join(""); // your secret key

  fetch(`${https://script.google.com/macros/s/AKfycbzsO2xFDpRNJbsHwnvEI6u1MHqKGHqNIEo3gNsoTNqso6W9xKu7DvFPlEcoX3iGmYY4/exec}?key=${AADIL87161}`)
    .then(res => res.json())
    .then(data => {
      if (data.error) throw new Error(data.error);
      console.log("✅ Secure data fetched:", data.length);
      allPlaces = data;
      restoreFilters();
      locateUser();
    })
    .catch(err => {
      console.error("⚠️ Secure data fetch failed:", err);
      locateUser();
    });
